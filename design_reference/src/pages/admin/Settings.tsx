...
const Toggle = ({ checked, onChange }: { checked: boolean; onChange: () => void }) => (
  <button
    ...
    onClick={onChange}
    className={`relative w-10 h-5.5 rounded-full transition-colors flex-shrink-0 ${checked ? 'bg-blue-600' : 'bg-slate-200'}`}
    style={{ height: '22px' }}
  >
    ...
    <div className="max-w-[900px] mx-auto space-y-5">
      ...
      <div className="flex gap-5">
        ...
        <div className="flex-1 bg-white rounded-xl border border-slate-200 p-5">
          <h2 className="font-display text-base font-700 text-slate-900 mb-1">
